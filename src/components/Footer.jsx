                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 text-sm font-medium">
                            <div className="flex items-start gap-4 group">
                                ...
                                <span className="text-gray-500 leading-relaxed max-w-[200px]">Ground Floor of Building No. 3100, Ward No. 2013/61, Manikath Road, Ravipuram, Kochi, Ernakulam, 682016</span>
                            </div>
