    ...
    return (
        <div className="space-y-4 animate-fade-in-up">
            ...
            <div className="space-y-4 max-w-4xl mx-auto text-center">
                <p className="text-gray-800 text-lg md:text-xl md:leading-relaxed leading-snug font-medium local-font-gayathri">
                    {description}
                </p>
                {secondaryDescription && (
                    <p className="text-gray-800 text-base md:text-lg md:leading-relaxed leading-snug font-medium italic border-t border-gray-100 pt-4 mt-4">
                        {secondaryDescription}
                    </p>
                )}
            </div>
