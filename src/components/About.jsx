    ...
    <section id="about" className="py-14 md:py-24 px-6 bg-white overflow-hidden relative">
      <div className="max-w-6xl mx-auto text-center space-y-12">
        ...
        <div className="space-y-4 animate-fade-in-up">
          <Header
            title="എന്തുകൊണ്ട്"
            highlight="ശ്രേയസ് കേന്ദ്ര?"
            description="എറണാകുളം കേന്ദ്രമാക്കി 2021 മുതൽ പ്രവർത്തിച്ചു വരുന്ന ശ്രേയസ് കേന്ദ്ര, ജനസേവന കേന്ദ്രത്തിന്റെ ആശയത്തോടൊപ്പം ഉയർന്ന വരുമാന സാധ്യതയുള്ള വിവിധ സർവീസുകൾ ഉൾപ്പെടുത്തിയ ഒരു സമഗ്ര ഡിജിറ്റൽ നെറ്റ്‌വർക്കാണ്."
          />
        </div>

        {/* Features Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-8 gap-4 md:pt-8 pt-4">
